            ...
            <div class="col-md-10">
              ...
              <h1>ADD KIDS</h1>
                  ...
                  <h2>Basic Details</h2>
                           ...
                           <li>
                             <label><b>Parent NIC Number</b></label>
                        ...
                        <h2>Parent Contact Details</h2>
                           ...
                           <br>
                            ...
                            <input type="text" name="fathername" placeholder="Father's Name" class="add full" pattern="[A-Za-z ]{5,}" title="Enter valide name"><br>
                           </li>
						   <li>
                            <label><b>Mother's Name</b></label>
                            <input type="text" name="mothername" placeholder="Mother's Name" class="add full" pattern="[A-Za-z ]{5,}" title="Enter valide name"><br>
                           </li>
                            <li>
                          ...
                          <li>
                           ...
                           <button type="submit" class="btn1" name="addkid" "><span>ADD </span></button>
                           </li>
                        </ul>                           
                    </form>
                </div>
...
<script src="js/validationKid.js"></script>
