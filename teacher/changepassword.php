...
<form action=dbchangepassword.php method="POST" class="changepassword">
	<table style='margin-top:50px;'>
            ...
            <tr>
                ...
                <td><?php echo '<input type="password" name="password" placeholder="Enter Current Password" class="add1" ></br>'?></td>
            </tr>
           
			<tr>
                <td class="lcolumn" width="30%"><label for="newpassword">New Password </label> :</td>
                <td><?php echo '<input type="password" placeholder="Enter new Password" name="newpassword"  class="add1" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{5,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 5 or more characters"></br>'?></td>
            </tr>
			
            <tr>
                <td class="lcolumn" width="30%"><label for="repeatnewpassword">Re-Enter New Password </label> :</td>
                <td><?php echo '<input type="password" placeholder="Re-Enter new Password" name="repeatnewpassword" class="add1" ></br>'?></td>
            </tr>
            <tr>
